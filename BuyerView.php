...
<head>
  ...
  <link rel="stylesheet" href="css/BuyerView.css">
...
<body>
    ...
    <div id="page-content-wrapper">
      <nav class="navbar navbar-expand-lg navbar-light bg-light py-4 px-4">
        <div class="d-flex align-items-center">
          ...
          <h2 class="fs-4 m-0">Buyer View</h2>
        </div>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header clearfix">
              <img class="modal-title" id="modal-title" src="/img/Buyer/buyer1.jpg"></img>
              <div class="fw-bold titlename ms-3">Sara</div>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <div class="row g-3">
                <div class="mb-3 col-md-6 input-P">
                  <label for="formGroupExampleInput" class="form-label">Purchase Date</label>
        ...
        <section>
          <div class="table-responsive mt-5 col-lg-12">
            <table class="table table-borderless table-sm table-hover table-striped caption-top" id="Table">
              <caption class="text-black fw-bolder"><label class="List">List of Buyer</label>
                <label class="Search">Search:<input type="search" id="SearchInput" class="form-control form-control-sm input-search" placeholder="Search For Buyer names" onkeyup="myFunction()"></label>
              </caption>
              <thead class="table-primary">
                <tr>
                  ...
                  <th scope="col" class="centerName">Purchase Date</i></th>

                  <th scope="col" class="centerName" onclick="sortName(2)">Location<i class="fas fa-sort d-inline"></i></th>
                  <th scope="col" class="center">Mobile</th>
                  <th scope="col" class="centerName" onclick="sortName(5)">Payment <i class="fas fa-sort"></i></th>
              ...
              <tbody>
                <tr>
                  <td scope="row" class="center">
                    <div class="d-flex align-items-center">
                      <img src="img/Buyer/buyer1.jpg" class="rounded-circle imgProfile" alt>
                      <div class="ms-2">
                        <p class="fw-bold mb-1">Sara</p>
                        <p class="text-muted mb-0">Sara@gmail.com</p>
                      </div>
                    </div>
                  </td>
                ...
                <tr>
                  <td scope="row" class="center">
                    <div class="d-flex align-items-center">
                      <img src="img/Buyer/buyer2.jpg" class="rounded-circle imgProfile" alt>
                      <div class="ms-2">
                ...
                <tr>
                  <td scope="row" class="center">
                    <div class="d-flex align-items-center">
                      <img src="img/Buyer/buyer3.jpg" class="rounded-circle imgProfile" alt>
                      <div class="ms-2">
                ...
                <tr>
                  <td scope="row" class="center">
                    <div class="d-flex align-items-center">
                      <img src="img/Buyer/buyer4.jpg" class="rounded-circle imgProfile" alt>
                      <div class="ms-2">
  ...
  <script src="./JS/BuyerView.js"></script>
