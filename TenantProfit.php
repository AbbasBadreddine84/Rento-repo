...
<head>
  ...
  <link rel="stylesheet" href="css/TenantProfit.css">
...
<body>
    ...
    <div id="page-content-wrapper">
      <nav class="navbar navbar-expand-lg navbar-light bg-light py-4 px-4">
        <div class="d-flex align-items-center">
          ...
          <h2 class="fs-4 m-0">Tenants Profit</h2>
        </div>
            ...
            <table class="table table-borderless table-sm table-hover table-striped caption-top" id="table">
              ...
              <thead class="table-primary">
                <tr>
                  ...
                  <th scope="col" class="center">Tenants Name</th>
                  <th scope="col" class="center">End of month</th>
                  <th scope="col" class="center">Invoice</th>
  ...
  <script src="./JS/TenantProfit.js"></script>
