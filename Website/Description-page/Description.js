function calculatePrice() {
    ...
    var perDayPayment=document.getElementById("perDay-payment");
    var advancedPayment=document.getElementById('advanced-payment');
    var totalPayment=document.getElementById('total-payment');
    var numberOdDays=document.getElementById("numberOfDays");

    var priceShown = document.getElementById("pricing_row");
    var priceHiden = document.getElementById("priceHiden");
    ...
    var pricePerDay = document.getElementById("price-per-day");
    var text1 = pricePerDay.textContent;
    var price1 = Number(text1);




    var timeDiference = Date2.getTime() - Date1.getTime();
    var days_difference = timeDiference / (1000 * 60 * 60 * 24);

    var totalPrice = price1 * days_difference;
    var advancedPrice=totalPrice*(40/100);

    if (priceShown) {

        if (priceShown.style.display === 'none') {

            priceShown.style.display = 'flex';
            priceHiden.style.display = 'none';

        } else {
            priceShown.style.display = 'none';
            priceHiden.style.display = 'flex';

        }
    }

    perDayPayment.innerHTML="$"+price1;
    advancedPayment.innerHTML="$"+advancedPrice;
    totalPayment.innerHTML="$"+totalPrice;
    numberOdDays.innerHTML=days_difference;
...
$(document).ready(function () {
    ...
    function addChosenDates(firstClicked, secondClicked, selected) {
        ...
        console.log("hijazi");
        console.log(selected.todayDate);
        return selected;
