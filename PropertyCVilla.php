...
<head>
  ...
  <link rel="stylesheet" href="css/PropertyCVilla.css">
      ...
      <div class="container-fluid px-5">
        <div class="row clearfix g-5 pt-5 pe-5">
          ...
          $query = "SELECT * FROM `admin`,`property` WHERE
           ...
           AND admin.AID=property.AdminId AND PropertyType='Villa'";
          ...
          <!-- <div class="col-md-6 col-sm-12 col-lg-4  d-flex align-items-stretch">
            <div class="card property_list hover-shadow">
              <div class="property_Image">
                <img src="img/images (1).jpg" class="img-thumbnail img-fluid" alt="England">
              ...
              <div class="body">
                <div class="property-content">
                  <div class="detail">
                    ...
                    <p class="contentText ms-3  mt-3 mb-0">
                      Offering city views and free WiFi, Knightsbridge Villa has accommodations ideally set in London, within a short distance of Harrods, Victoria and Albert Museum and Natural History Museum London. Each unit comes with a fully equipped kitchen with a fridge, a seating area with a sofa bed, a flat-screen TV, a washing machine, and a private bathroom with bath or shower
                    </p>
                  </div>
                  <div class="property-icon mt-3 ms-1">
                    <a href="#" title="Square Feet"><i class="fas fa-bed "></i>
          ...
          <div class="col-md-6 col-sm-12 col-lg-4  d-flex align-items-stretch">
            <div class="card property_list hover-shadow">
              <div class="property_Image">
                <img src="img/images.jpg" class="img-thumbnail img-fluid" alt="England">
          ...
          <div class="col-md-6 col-sm-12 col-lg-4  d-flex align-items-stretch">
            <div class="card property_list hover-shadow">
              <div class="property_Image">
                <img src="img/download (1).jpg" class="img-thumbnail img-fluid" alt="England">
                <span class="badge badge_Rent"> For Rent</span>
              </div>
              <div class="body">
                <div class="property-content">
